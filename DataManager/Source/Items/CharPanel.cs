...
namespace zDBManager
{
    public partial class CharPanel : UserControl
    {
        ...
        Rectangle[] positions = new Rectangle[EquipNum] { 
            new Rectangle(3, 65, 47, 72), 
            new Rectangle(222, 65, 47, 72),
            new Rectangle(114, 3, 46, 46), 
            new Rectangle(114, 65, 46, 72), 
            new Rectangle(114, 156, 46, 45),
            new Rectangle(3, 156, 46, 46), 
            new Rectangle(222, 156, 48, 46),
            new Rectangle(185, 3, 87, 46),
            new Rectangle(3, 3, 46, 46),
            new Rectangle(72, 28, 20, 20), 
            new Rectangle(72, 177, 20, 20), 
            new Rectangle(182, 177, 20, 20)};
